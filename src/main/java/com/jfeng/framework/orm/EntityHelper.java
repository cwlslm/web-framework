...
import com.jfeng.framework.orm.annotation.Column;
import com.jfeng.framework.orm.annotation.Entity;
import com.jfeng.framework.orm.annotation.Table;
...
public class EntityHelper {
    ...
    static {
        // 获取并遍历所有实体类
        Set<Class<?>> entityClassList = ClassHelper.getClassSetByAnnotation(Entity.class);
